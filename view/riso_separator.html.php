...
<div class="riso-container">
    ...
    <div id="separatorSection" style="display: none;">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" href="#commonTools">
                        <i class="fa fa-cogs"></i> <?php _e('riso_separator.tools'); ?> & <?php _e('riso_separator.effects'); ?> <small>(S'applique au mode actif)</small> <i class="fa fa-caret-down"></i>
                    </a>
                </h4>
            </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-info" onclick="applyPosterization()"><i class="fa fa-th"></i> <?php _e('riso_separator.posterize_button'); ?></button>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-4">
                             <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-info" onclick="applyHalftoneEffect()"><i class="fa fa-th-large"></i> <?php _e('riso_separator.halftone_trames'); ?></button>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <ul class="nav nav-tabs" role="tablist" id="modeTabs">
            <li role="presentation" class="active"><a href="#pane-rgb" aria-controls="pane-rgb" role="tab" data-toggle="tab" onclick="switchTab('RGB')"><?php _e('riso_separator.rgb_3_channels'); ?></a></li>
            <li role="presentation"><a href="#pane-cmyk" aria-controls="pane-cmyk" role="tab" data-toggle="tab" onclick="switchTab('CMYK')"><?php _e('riso_separator.cmyk_4_channels'); ?></a></li>
            <li role="presentation"><a href="#pane-2color" aria-controls="pane-2color" role="tab" data-toggle="tab" onclick="switchTab('2COLOR')"><?php _e('riso_separator.2_drums_nb'); ?></a></li>
            <li role="presentation"><a href="#pane-pipette" aria-controls="pane-pipette" role="tab" data-toggle="tab" onclick="switchTab('PIPETTE')"><?php _e('riso_separator.pipette_isolate_color'); ?></a></li>
        </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="channel-panel">
                            <h5><i class="fa fa-circle" style="color: <?php echo $chan['color']; ?>;"></i> <?php echo $chan['name']; ?></h5>
                            <canvas id="<?php echo $chan['id']; ?>Canvas" class="img-thumbnail"></canvas>
                            <div class="layer-controls">
                                <label><?php _e('riso_separator.drum'); ?></label>
                                <select class="form-control tambour-select" id="<?php echo $chan['id']; ?>Tambour" onchange="updatePreview()">
                                    <?php foreach ($tambours as $val => $label) {
                                        $selected = ($val == $chan['default']) ? 'selected' : '';
                                        echo "<option value=\"$val\" $selected>$label</option>";
                                    } ?>
                                </select>
                                <label style="margin-top: 10px;"><?php _e('riso_separator.opacity_label'); ?> <span id="<?php echo $chan['id']; ?>Opacity">100</span>%</label>
                                <input type="range" class="form-control" id="<?php echo $chan['id']; ?>OpacitySlider" min="0" max="100" value="100" oninput="updateOpacityLabel('<?php echo $chan['id']; ?>'); updatePreview()">
                                <button class="btn btn-sm btn-success btn-block" style="margin-top: 10px;" onclick="exportChannel('<?php echo $chan['id']; ?>')">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="pipetteInfo" style="display: none; margin-top: 15px;">
                            <div class="alert alert-info">
                                ...
                                <button class="btn btn-success btn-block" style="margin-top: 10px;" onclick="applyPipette()">
...
function exportChannel(id) {
    ...
    if (tambour === 'none') {
        alert('Veuillez sélectionner un tambour.');
        return;
    }
