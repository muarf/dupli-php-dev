    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="page-header text-center"
                style="background: linear-gradient(135deg, #a8e6cf 0%, #c3f0ca 100%); padding: 30px; border-radius: 10px; margin-bottom: 30px;">
            ...
            <?php if (!empty($errors)): ?>
                <div class="alert alert-danger">
                    <h4><i class="fa fa-exclamation-triangle"></i> <?php _e('png_to_pdf.errors_detected'); ?></h4>
                    <ul class="mb-3">
                ...
                <div class="panel-body">
                    <form method="POST" enctype="multipart/form-data" id="imageForm">
                                    ...
                                    <div class="panel-body">
                                        <div class="radio">
                                            <label>
                                                ...
                                                <strong><?php _e('png_to_pdf.portrait'); ?></strong> <i
                                        ...
                                        <div class="radio">
                                            <label>
                                                ...
                                                <strong><?php _e('png_to_pdf.landscape'); ?></strong> <i
                        ...
                        <div id="fileUploadArea"
                            style="border: 3px dashed #a8e6cf; border-radius: 15px; padding: 40px; text-align: center; background: linear-gradient(135deg, #f5fff5 0%, #e8ffe8 100%); transition: all 0.3s ease; cursor: pointer;">
                            ...
                            <div id="uploadText">
                                ...
                                <input type="file" name="images[]" id="images" accept="image/png,image/jpeg,image/jpg"
                                    multiple style="display: none;" required>
                                <button type="button" class="btn btn-lg"
                                    style="background: #a8e6cf; border: none; color: white; padding: 12px 30px; border-radius: 25px;">
                            ...
                            <div id="fileInfo" style="display: none;">
                                ...
                                <div id="fileList"
                                    style="color: #666; margin-bottom: 15px; max-height: 150px; overflow-y: auto;">
                                </div>
