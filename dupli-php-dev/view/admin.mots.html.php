  ...
  <script>
    ...
    document.getElementById('password-form').addEventListener('submit', function (e) {
      ...
      if (newPassword !== confirmPassword) {
        ...
        showAppModal({
          type: 'warning',
          message: '<?php echo __('admin_mots.passwords_dont_match'); ?>'
        });
        return false;
      }
      ...
      if (newPassword.length < 6) {
        ...
        showAppModal({
          type: 'warning',
          message: '<?php echo __('admin_mots.password_too_short'); ?>'
        });
        return false;
      }
    });
    ...
    document.getElementById('confirm_password').addEventListener('input', function () {
      ...
      if (confirmPassword && newPassword !== confirmPassword) {
        this.setCustomValidity('<?php echo __('admin_mots.passwords_dont_match_realtime'); ?>');
      } else {
