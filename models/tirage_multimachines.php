...
function generateMachineHTML($index, $duplicopieurs, $duplicopieur_selectionne, $photocopiers) {
    ...
    // Fonction helper pour les traductions (comme _e() mais retourne la valeur)
    $__ = function($key) {
        return __($key);
    };
        ...
        <div class="panel-heading" style="cursor: pointer;">
            <div class="row" onclick="toggleMachinePanel(' . $index . ')">
                ...
                <div class="col-xs-4 col-sm-3 text-right">
                    <span class="machine-price-preview" id="price-preview-' . $index . '">0.00 ' . $__('tirage_multimachines.currency') . '</span>
                </div>
            </div>
        </div>
    ...
    if(isset($duplicopieur_selectionne)) {
        ...
        $html .= '<p class="form-control-static text-danger">' . $__('tirage_multimachines.no_duplicopieur') . '</p>';
    }
    ...
    $html .= '</div>
                    ...
                    <div class="form-group" id="tambour-group-' . $index . '" style="display: none;">
                        <label class="col-md-3 control-label">
                            <i class="fa fa-circle" style="margin-right: 5px;"></i> ' . $__('tirage_multimachines.tambour_used') . '
                        </label>
                        <div class="col-md-9">
                            <select name="machines[' . $index . '][tambour]" class="form-control" id="tambour-select-' . $index . '">
                                
                            </select>
                            <span class="help-block">' . $__('tirage_multimachines.choose_tambour') . '</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px; margin: 10px 0;">
                        <label class="col-md-2 control-label">
                            <i class="fa fa-sliders" style="margin-right: 5px;"></i> ' . $__('tirage_multimachines.options') . '
                        </label>
                        <div class="col-md-10">
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-sm-3">
                                    <div class="checkbox">
                                        <label for="rv_' . $index . '">
                                            ...
                                            <i class="fa fa-files-o"></i> ' . $__('tirage_multimachines.recto_verso') . '
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="checkbox">
                                        <label for="feuilles_payees_' . $index . '">
                                            ...
                                            <i class="fa fa-money" style="color: #f39c12;"></i> ' . $__('tirage_multimachines.sheets_already_paid') . '
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12" style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 10px; border-left: 4px solid #28a745;">
                        <legend style="border-bottom: 2px solid #dee2e6; padding-bottom: 10px; margin-bottom: 15px; font-size: 18px;">
                            <i class="fa fa-keyboard-o" style="margin-right: 8px; color: #28a745;"></i> ' . $__('tirage_multimachines.input_mode') . '
                        </legend>
                        <div class="form-group">
                            <label class="col-md-3 control-label">' . $__('tirage_multimachines.input_type') . '</label>
                            <div class="col-md-4">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="machines[' . $index . '][mode_saisie]" value="compteurs" checked onchange="toggleSaisieMode(' . $index . ')">
                                        ' . $__('tirage_multimachines.counters_before_after') . '
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="machines[' . $index . '][mode_saisie]" value="manuel" onchange="toggleSaisieMode(' . $index . ')">
                                        ' . $__('tirage_multimachines.masters_and_passes') . '
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset style="border: 1px solid #ddd; padding: 15px; border-radius: 5px;">
                                        <legend style="width: auto; padding: 0 10px; font-size: 16px; margin-bottom: 10px;">' . $__('tirage_multimachines.counters_before') . '</legend>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label" for="master_av_' . $index . '">' . $__('tirage_multimachines.masters') . '</label>  
                                            <div class="col-xs-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label" for="passage_av_' . $index . '">' . $__('tirage_multimachines.passes') . '</label>  
                                            <div class="col-xs-8">
                                ...
                                <div class="col-md-6">
                                    <fieldset style="border: 1px solid #ddd; padding: 15px; border-radius: 5px;">
                                        <legend style="width: auto; padding: 0 10px; font-size: 16px; margin-bottom: 10px;">' . $__('tirage_multimachines.counters_after') . '</legend>
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label" for="master_ap_' . $index . '">' . $__('tirage_multimachines.masters_label') . '</label>  
                                            <div class="col-xs-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label" for="passage_ap_' . $index . '">' . $__('tirage_multimachines.passes') . '</label>  
                                            <div class="col-xs-8">
                        ...
                        <div id="manuel-mode-' . $index . '" class="saisie-mode" style="display:none;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label" for="nb_masters_' . $index . '">' . $__('tirage_multimachines.masters_label') . '</label>  
                                        <div class="col-xs-8">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label" for="nb_passages_' . $index . '">' . $__('tirage_multimachines.passes_label') . '</label>  
                                        <div class="col-xs-8">
    ...
    $html .= '</select>
                            <span class="help-block">' . $__('tirage_multimachines.which_photocopier') . '</span>
                </div>
            </div>
                    ...
                    <div class="brochures-container" data-machine="' . $index . '">
                        <h5 style="background: #f8f9fa; padding: 12px; border-radius: 5px; margin-bottom: 15px; border-left: 3px solid #9c27b0;">
                            <i class="fa fa-book" style="margin-right: 8px; color: #9c27b0;"></i> ' . $__('tirage_multimachines.brochures_tracts') . '
                        </h5>
                        <div class="brochure-item" data-brochure="0" style="padding: 15px; background: #ffffff; border: 1px solid #dee2e6; border-radius: 5px; margin-bottom: 10px;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" for="nb_exemplaires_' . $index . '_0">
                                            <i class="fa fa-copy"></i> ' . $__('tirage_multimachines.number_copies') . '
                                        </label>  
                                        ...
                                        <small class="text-muted">' . $__('tirage_multimachines.copies_question') . '</small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" for="nb_feuilles_' . $index . '_0">
                                            <i class="fa fa-file-text-o"></i> ' . $__('tirage_multimachines.sheets_per_copy') . '
                                        </label>  
                                        ...
                                        <small class="text-muted">' . $__('tirage_multimachines.pages_per_copy') . '</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">
                                            <i class="fa fa-calculator"></i> ' . $__('tirage_multimachines.total_sheets') . '
                                        </label>
                                        <div class="well well-sm" style="margin: 0; padding: 8px; background: #f8f9fa; border: 1px solid #ddd;">
                                            ...
                                            <small class="text-muted">(' . $__('tirage_multimachines.sheets_calculation') . ')</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="radios_' . $index . '_0">' . $__('tirage_multimachines.size') . '</label>
                                        <div> 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label"><i class="fa fa-cogs"></i> ' . $__('tirage_multimachines.options') . '</label>
                ...
                <div class="form-group" style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 15px; border-left: 4px solid #28a745;">
                    <label class="col-md-4 control-label" style="font-size: 14px; font-weight: normal;">
                        <i class="fa fa-euro" style="margin-right: 5px; color: #28a745;"></i> ' . $__('tirage_multimachines.price_this_tirage') . '
                    </label>
                    <div class="col-md-8">
